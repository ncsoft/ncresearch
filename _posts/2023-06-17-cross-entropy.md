...
![]({{"/assets/img/post/481b04ee12af454ab1de6dde2576eb4c15f8047a/2_Cross_Entropy.jpg"| relative_url}}){: width="75%"}
*Cross Entropy 수식*
...
![]({{"/assets/img/post/481b04ee12af454ab1de6dde2576eb4c15f8047a/4_BCE_loss.png"| relative_url}}){: width="75%"}

위의 BCE Loss 수식을 이용하면 아래와 같이 계산됩니다.

![]({{"/assets/img/post/481b04ee12af454ab1de6dde2576eb4c15f8047a/5_BCE_loss2.png"| relative_url}}){: width="75%"}
...
![]({{"/assets/img/post/481b04ee12af454ab1de6dde2576eb4c15f8047a/8_p_t.png"| relative_url}}){: width="60%"}

이제 $$p_t$$를 이용해서 BCE Loss를 아래와 같이 간결하게 작성할 수 있게 되었습니다.

![]({{"/assets/img/post/481b04ee12af454ab1de6dde2576eb4c15f8047a/9_BCE_new_form.png"| relative_url}}){: width="60%"}
...
![]({{"/assets/img/post/481b04ee12af454ab1de6dde2576eb4c15f8047a/10_FL.png"| relative_url}}){: width="60%"}
...
사실 이 밖에도 Vision 분야에서는 여러 유용한 손실 함수들이 있었는데요(Cui et al. (CVPR 2019)[^7], Taghanaki et al. (CMIG 2019)[^8], Wu et al. (ECCV 2020)[^9]). 이 연구들의 공통점은 `데이터가 불균형한 상황에서, 손실 함수의 변경을 통해 좋은 성능을 이끌어 내었다`입니다. 
