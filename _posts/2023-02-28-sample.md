...
[링크](https://ncsoft.github.io/ncnlp/sample)는 링크 텍스트를 대괄호로 묶고 소괄호 안에 링크를 넣습니다.
...
Sidenote는 본문에서 다루는 내용과는 관련이 있지만, 그 내용에 대한 부가적인 정보나 간단한 주석을 말합니다. 일반적으로 본문에서 별도의 단락이나 괄호 안에 적혀 있습니다. 이것은 독자에게 더 깊은 이해를 제공하거나, 저자가 주장하려는 바를 더 명확하게 전달하기 위해 사용됩니다.
</small>
</span>
-!sidenote2!-를 추가할 수 있습니다.
