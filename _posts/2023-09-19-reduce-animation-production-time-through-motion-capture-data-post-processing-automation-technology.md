...
엔씨는 총 100대의 카메라가 있는 150m2 규모의 자체 모캡 스튜디오를 운영하고 있습니다. 엔씨에서 개발하는 모든 게임과 콘텐츠는 이 모캡 스튜디오에서 촬영되기 때문에, 매일 대량의 모션 데이터가 생기고 있습니다. 애니메이션 분야는 공개된 데이터셋이 많이 없고, 데이터의 양이 부족하다는 점을 고려하면 AI 연구자로서 엔씨소프트는 매우 매력적인 환경이라고 생각합니다.
