---
layout: post
title: "문장 복원을 통한 구조 이해 능력의 비지도 향상"
icon: paper
...
<p align="center">
<img src="assets/img/post/195e5588d76145a5becc6052cdbf9cfa5092dcbe/prod_ comp.jpg" width="400"></p>
<div style="text-align: center;">
Competence 와 performance</div>
...
<p align="center">
<img src="assets/img/post/195e5588d76145a5becc6052cdbf9cfa5092dcbe/tokens_calc.png" width="400"/>
</p>
...
<p align="center">
<img src="assets/img/post/195e5588d76145a5becc6052cdbf9cfa5092dcbe/easy_korean.png" width="400"/>
</p>
...
<p align="center">
<img src="assets/img/post/195e5588d76145a5becc6052cdbf9cfa5092dcbe/chatgpt_vs_gukbap.png" width="400"/>
</p>
<div style="text-align: center;">뜨끈~하고 든든~한 국밥 앞에서 ChatGPT란....</div>
...
<p align="center">
<img src="assets/img/post/195e5588d76145a5becc6052cdbf9cfa5092dcbe/chatgpt.png" width="600"/>
</p>
...
<p align="center">
<img src="assets/img/post/195e5588d76145a5becc6052cdbf9cfa5092dcbe/reversal.png" width="800"/>
</p>
...
<p align="center">
<img src="assets/img/post/195e5588d76145a5becc6052cdbf9cfa5092dcbe/faker.jpg" width="600"/>
</p>
<div style="text-align: center;">Lee "Faker" Sang-hyeok (Hangul: 이상혁) is a League of Legends esports player, currently mid laner and part owner at T1.</div>
...
<div style="text-align: center;">문장 복원 학습 예시</div>

이 데이터셋을 t5-base 라는 인코더-디코더 구조 사전학습 언어모델에 문장부호 복원을 추가적으로 학습한 뒤, 6개 태스크, 17개 데이터셋에 내부 분포 (같은 데이터셋을 학습/평가에 사용) 와 외부 분포 (한 데이터셋으로 학습, 다른 데이터셋으로 평가) 성능을 측정해 보았습니다. 아래의 표에서 문장부호 복원이 구조 이해 성능을 얼마나 향상시켰는지 정리해 보도록 해요. 
...
<p align="center">
<img src="assets/img/post/195e5588d76145a5becc6052cdbf9cfa5092dcbe/architecture.png" width="600"/>
</p>
...
<p align="center">
<img src="assets/img/post/195e5588d76145a5becc6052cdbf9cfa5092dcbe/doguri.jpg" width="600"/>
</p>
<div style="text-align: center;">이해기술실 막내인 필자는......행복합니다!</div>
...
<p align="center">
<img src="assets/img/post/195e5588d76145a5becc6052cdbf9cfa5092dcbe/doguri_nods.gif" width="400"/>
</p>
