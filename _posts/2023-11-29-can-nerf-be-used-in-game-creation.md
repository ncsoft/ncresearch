...
> **작성자**
> - 이름: 허환 (Vision AI Lab)
> - - 소개: 안녕하세요, AI를 활용한 3D 모델링, 그래픽 기술을 연구하고 있습니다.
>
> **이런 분이 읽으면 좋습니다!**
...
<iframe width="100%" style="height:calc(100vw * 0.56);max-height:600px;" src="https://www.youtube.com/embed/mV8CMTjB6dY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
{:.center_div}
*영상2. Diffuse Specular 가 분리된 NeRF Scene 모델링*
{:.center_div}

<iframe width="100%" style="height:calc(100vw * 0.56);max-height:600px;" src="https://www.youtube.com/embed/YKjVm4uOP6I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
{:.center_div}
