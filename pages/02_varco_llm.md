...
|공개 일정|모델명|
|**2023.08.10**|{::nomarkdown}<p><a href="https://ncsoft.github.io/ncresearch/varco-llm-details#varco-llm-ko-13b-ist-1"><b><u>VARCO LLM KO-13B-IST</u></b></a></p><ul><li>VARCO LLM 13B-IST 모델은 13B-FM 모델을 NC에서 자체 구축한 Instruction 데이터 셋으로 추가 학습한 모델입니다.</li><li>13B-FM 모델의 기본적인 성능에 더하여 사용자가 입력하는 프롬프트를 잘 수행하도록 학습되었기 때문에 보다 유연하게 다양한 태스크에 활용될 수 있습니다.</li><li>추론과 생성 능력에 집중하였습니다. 워크플로우의 자동화를 통해 생산성을 향상하고, One-stop 서비스형 챗봇, 개성이 묻어나는 챗봇 등을 제작하여 고객에게 새로운 경험을 제공하세요.</li></ul>{:/}|
