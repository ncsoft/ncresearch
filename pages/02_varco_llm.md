...
|{::nomarkdown}<p class="gray_p">2023.08.29</p>{:/}|{::nomarkdown}<p class="gray_p"><b>VARCO LLM Bi-13B-IST</b></p><p class="gray_p">한국어와 영어를 동시에 학습한 13B-FM 모델을 기반으로 사용자의 프롬프트를 잘 수행하도록 추가 학습된 모델입니다.</p>{:/}|
